function [num_engines_stage1, num_engines_stage2, total_mass] = get_MER_total_mass(first_stage, second_stage, X)
    ...
    while residual > tol
        ...
        stage2_total_mass = get_stage2_mass(second_stage, M_p, M_0, num_engines_stage2, false);
    ...
    while residual > tol
        ...
        num_engines_stage1 = stage1_total_mass*g0*T_to_W_second/stage1_thrust_single;
